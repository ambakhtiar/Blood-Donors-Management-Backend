---
name: problem-fix
description: "Problem Fix for Blood-Donors-Management-Backend. 5 error→fix pairs."
domain: problem-fix
composesFrom:
  - fix
triggers:
...
|-------|-----|------|
| `PrismaClientKnownRequestError,` | problem-fix in index.js | 4x |
| `"use strict";var h=Object.defineProperty;var T=Obj` | problem-fix in query_compiler_fast_bg.js | 2x |
